...
const handleFolderClick = function() {
    const folderNames= this.parentElement;
    const childFolder = folderNames.querySelector('.folder-content');
